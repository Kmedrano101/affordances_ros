...
NODE_NAME = rospy.get_param(PACKAGE_NAME+"node_po_name",default="person_object")
TOPIC_S1_NAME = rospy.get_param(PACKAGE_NAME+"subscribers/object_bounding_boxes/topic", default="/darknet_ros/bounding_boxes")
TOPIC_S2_NAME = rospy.get_param(PACKAGE_NAME+"subscribers/number_object/topic", default="/darknet_ros/found_object")
TOPIC_P1_NAME = rospy.get_param(PACKAGE_NAME+"publishers/bounding_boxes/topic",default="/affordances/object_bounding_boxes")
TOPIC_P2_NAME = rospy.get_param(PACKAGE_NAME+"publishers/flag/topic",default="/affordances/flag")
...
class PersonObject:
	...
	def start_publishers(self) -> None:
		self._pubTopicFlag = rospy.Publisher(self._pubTopicFlagName, Bool, queue_size=10)
		self._pubTopicObjectBoxes = rospy.Publisher(self._pubTopicObjectBoxesName, BoundingBoxes, queue_size=10)
